...
const LogForm = () => {
  ...
  return (
    <div className='w-full max-w-2xl bg-gray-200 -z-2 mx-auto  mt-[14vh]  overflow-hidden rounded-lg shadow'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4 p-4 mt-10'>
        <div className='md:col-span-2 grid grid-rows-2 h-fit gap-4'>
          {guidanceSkills && (
            <input
              type="text"
          ...
          <input
            ...
            className='bg-gray-300 px-4 py-2 outline-none rounded w-full'
          />
        </div>
        <div>
          {guidanceSkills && (
      ...
      <div className="px-4 pb-6 flex flex-col items-center md:items-start">
        <button
          className='font-semibold bg-[#71C55D] hover:bg-green-500 text-white px-6 py-2 rounded-full transition-colors duration-200 cursor-pointer w-full md:w-auto'
        >
          Generate
        </button>
      </div>
